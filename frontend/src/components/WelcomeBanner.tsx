...
export function WelcomeBanner({
  ...
  return (
    <section
      className={`welcome-banner${collapsed ? ' welcome-banner--collapsed' : ''}`}
      aria-label="About Flux"
    >
      <div className="welcome-top">
        <span className="welcome-label">Flux guide</span>
        <button
          type="button"
        ...
        <div className="welcome-content">
          ...
          {(onGoPlayground || onGoBenchmarks) && (
            <div className="welcome-actions">
              ...
              {onGoBenchmarks && (
                <button type="button" className="welcome-action-btn" onClick={onGoBenchmarks}>
                  View Benchmarks
                </button>
              )}
            </div>
